      ...
      (let* ((detailed-translation
             ...
             (gtos
              (make-gtos
               ...
               :suggestion (when (null detailed-translation) nil)))
;;                             (google-translate-json-suggestion json)))) -- Ed was here
...
(defun google-translate-current-buffer-output-translation (gtos)
  ...
  (goto-char (point-max)) ;; Ed - reverse translate at end
  (insert "\n\n\n")
...
(defun google-translate-buffer-output-translation (gtos)
  ...
  (let ((buffer-name "*Google Translate*"))
    (with-output-to-temp-buffer buffer-name
      ...
      ;; Ed - changing major mode makes buffer read-write       
      ;;https://www.gnu.org/software/emacs/manual/html_node/elisp/Temporary-Displays.html#Temporary-Displays
      (text-mode)
